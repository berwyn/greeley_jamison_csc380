...
public class Service {
    ...
    public List<Service.Restaurant> restaurant;
    ...
    public static class Restaurant {
        ...
        public List<Service.Restaurant.Meal> meal;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link Service.Restaurant.Meal }
         * 
         * 
         */
        public List<Service.Restaurant.Meal> getMeal() {
            if (meal == null) {
                meal = new ArrayList<Service.Restaurant.Meal>();
            }
            return this.meal;
        }
